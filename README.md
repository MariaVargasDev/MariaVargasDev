...
Mi nombre es Maria Angel Vargas Suarez y soy un desarrollador backend junior de Colombia, apasionado por construir aplicaciones robustas, escalables y bien estructuradas. Me especializo en **PHP** y **Laravel**, complementando mi desarrollo con **JavaScript** para el frontend y **MySQL** para el diseño y gestión de bases de datos.

Disfruto resolver problemas reales a través del código, y estoy en constante aprendizaje para mejorar mis habilidades como desarrollador, explorando buenas prácticas, patrones de diseño y arquitecturas limpias.

Actualmente estoy enfocado en fortalecer mis conocimientos en el desarrollo backend, con el objetivo de crear soluciones eficientes y con un buen mantenimiento a largo plazo.

## 🚀 Proyectos destacados

- **Proyecto 1** — descripción corta de una línea
